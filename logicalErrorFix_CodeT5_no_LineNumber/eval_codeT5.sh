...
test_model=$output_dir/checkpoint-best-bleu-CodeT5/pytorch_model.bin #checkpoint for test
#test_model=$output_dir/checkpoint-best-ppl-CodeT5/pytorch_model.bin #checkpoint for test
#test_model=$output_dir/checkpoint-last-CodeT5/pytorch_model.bin #checkpoint for test
